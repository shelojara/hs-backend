...
from manga.drive_picker_admin_views import google_drive_picker, google_drive_picker_access_token
...
urlpatterns = [
    ...
    path(
        "admin/manga/googledrive/picker/",
        google_drive_picker,
        name="admin_manga_gdrive_picker",
    ),
    path(
        "admin/manga/googledrive/picker/token/",
        google_drive_picker_access_token,
