...
# GROCERIES_RECIPE_SEARCH: when false, recipe-classified queries use single product fetch
# (same as product/brand). Default on; disable via FlagState in admin if needed.
FLAGS: dict[str, list] = {
