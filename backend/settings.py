...
# GROCERIES_RECIPE_SEARCH: when enabled via FlagState in admin, skip Gemini query-kind
# classification and treat every search as product (no recipe ingredient expansion).
FLAGS: dict[str, list] = {
